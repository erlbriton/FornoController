...
private:
	static constexpr std::array<vu8, 4096> rawADC = {
			    ...
			    BOOST_PP_REPEAT(200,   REPEAT, 2)
			    BOOST_PP_REPEAT(200,   REPEAT, 2)
				BOOST_PP_REPEAT(156,   REPEAT, 2)
				BOOST_PP_REPEAT(200,   REPEAT, 3)
				BOOST_PP_REPEAT(200,   REPEAT, 3)
				BOOST_PP_REPEAT(199,   REPEAT, 3)
				BOOST_PP_REPEAT(200,   REPEAT, 4)
				BOOST_PP_REPEAT(200,   REPEAT, 4)
				BOOST_PP_REPEAT(111,   REPEAT, 4)
				BOOST_PP_REPEAT(250,   REPEAT, 5)
				BOOST_PP_REPEAT(200,   REPEAT, 5)
				BOOST_PP_REPEAT(200,   REPEAT, 6)
				BOOST_PP_REPEAT(168,   REPEAT, 6)
				BOOST_PP_REPEAT(200,   REPEAT, 7)
				BOOST_PP_REPEAT(118,   REPEAT, 7)
				BOOST_PP_REPEAT(200,   REPEAT, 8)
				BOOST_PP_REPEAT(119,   REPEAT, 8)
				BOOST_PP_REPEAT(200 ,  REPEAT, 9)
				BOOST_PP_REPEAT(68,    REPEAT, 9)
				BOOST_PP_REPEAT(200,   REPEAT, 10)
				BOOST_PP_REPEAT(93,    REPEAT, 10)
